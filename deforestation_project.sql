...
select round(forest_area_sqkm::numeric,2) as total_forest_1990
from forestation
where region = 'World'
  and year = 1990
...
--d. What was the percent change in forest area of the world between 1990 and 2016?
     ...
     and year = 2016
      ...
      on fa90.region = fa16.region
;
/* can i use these columns or do i need to create a separate query to show the difference
select 
case when year = 1990 then forest_area_sqkm end as fa90,
case when year = 2016 then forest_area_sqkm end as fa16
fa90 - fa16 
from forestation
